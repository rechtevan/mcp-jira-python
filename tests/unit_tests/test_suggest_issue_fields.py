...
class TestSuggestIssueFields:
    ...
    def test_excludes_project_and_issuetype(self, tool: SuggestIssueFieldsTool) -> None:
    ...
    def test_case_insensitive_issue_type(self, tool: SuggestIssueFieldsTool) -> None:
    ...
    def test_invalid_issue_type_error(self, tool: SuggestIssueFieldsTool) -> None:
        ...
        result = asyncio.run(tool.execute({"projectKey": "PROJ", "issueType": "Invalid"}))
